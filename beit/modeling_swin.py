...
__all__ = [
    'beit_base_swin_patch4_win7_224_8k_vocab',
]
...
class SwinTransformer(nn.Module):
    ...
    def forward(self, x, bool_masked_pos, return_all_tokens=False):
        ...
        if return_all_tokens:
            ...
            return self.head(x[bool_masked_pos])
...
@register_model
def beit_base_swin_patch4_win7_224_8k_vocab(pretrained=False, **kwargs):
